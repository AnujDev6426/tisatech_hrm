...
function LegacyUpdate() {
  ...
  useEffect(() => {
    ...
    if (formik?.values?.discount_amount != "") {
      formik.setValues({
        ...formik.values, // Keep the current values
        actual_amount: totalAmount - DiscountAmount, // Update total_amount
        duo_amount: totalAmount - DiscountAmount,
      });
    }
  ...
  useEffect(() => {
    ...
    if (formik?.values?.pay_amount != "") {
      formik.setValues({
        ...formik.values,
        duo_amount: totalAmount - PayAmount,
      });
    }
  ...
  useEffect(() => {
    if (formik.values.student) {
      ...
      setSelectedStudent(selected || null); // Update the selected option
    }
  }, [formik.values.student]);
  ...
  }, [formik.values.course, formik?.values?.student]);
