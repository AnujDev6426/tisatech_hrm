        ...
        <div className="emp_dash">
          <div className="page_manus">
            ...
            <div className="page_heading display">
              <h4 className="pb-3">Employee Management</h4>
            </div>
          </div>
          <div className="search_show_entries display justify-content-between mt-4">
            <div className="  position-relative W-100 display justify-content-between p-4 pt-2 pb-2"></div>
            <div className="apply_application">
              <Link href="/employee-add" className="btn comman_btn">
                ...
                <div class="card-body">
                  <form className="mb-3" onSubmit={handleSearch}>
                    <div className="row g-3 g-xl-5 g-xxl-5">
                      ...
                      {/* <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-3">
                          <label htmlFor="address" className="form-label">Course </label>
                          <select
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th> Email</th>
                      <th> Mobile</th>
                      <th className="reason">Designation</th>
                      <th className="reason"> Salary</th>
                    ...
                    {data?.length > 0
                      ? data.map((res, i) => (
                          <tr key={i}>
                            ...
                            <td>{res?.mobile}</td>
                            <td>
                              {res?.designation ? res?.designation : "N/A"}
                            </td>
                            <td>
                              {res?.salary ? MoneyFormat(res?.salary) : "N/A"}
                            </td>
